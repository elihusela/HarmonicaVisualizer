...
@pytest.fixture
def dummy_pipeline(mock_tab_mapper, mock_animator, mock_audio_extractor) -> HarmonicaTabsPipeline:
...
@pytest.fixture
def configured_pipeline(dummy_pipeline, mock_tab_mapper, mock_animator, mock_audio_extractor):
